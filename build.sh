...
ld -m elf_i386 -T link.ld -o bin/kernel.elf bin/kernel_entry.o bin/isr_stubs.o bin/idt_flush.o bin/kernel.o bin/gdt.o bin/paging.o bin/kheap.o bin/vga.o bin/isr.o bin/idt.o 
